...
public class aiinput : MonoBehaviour
{
    ...
    public Transform aheadwaypoint;
    ...
    public void aispwan()
    {
        if(previouswaypoint!=null && levelreach==false)
        {
    ...
    void calculateDistanceofWaypoint()
    {
        ...
        for (int i = levelwaypoint; i < maxnode; i++)
        {
            ...
            {
                if(i>levelwaypoint+2)
                previouswaypoint = nodes[i-2];
                aheadwaypoint = nodes[i + 2];
